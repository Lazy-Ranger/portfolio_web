      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            rounded-full px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50"
          >
            Contact
            <Image
        ...
        <ul
          ...
          bg-rose-50 transaction duration-500 dark:bg-darkHover dark:text-white"
        >
