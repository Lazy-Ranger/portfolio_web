        ...
        <div className="flex-1">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-xl">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <li
                key={index}
                className="text-lg font-Ovo border-[0.5px] hover:shadow-dark border-gray-400 
                rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50"
              >
          ...
          <h4 className="my-6 text-gray-700 font-Ovo dark:text-white/80">Tool we use</h4>
