    ...
    <div id="service" className="w-full px-[12%] py-10 scroll-mt-24">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 my-10">
        {serviceData?.map(({ icon, title, description, link }, index) => (
          <div key={index} className="border border-gray-400 rounded-lg px-8 py-12 cursor-pointer hover:bg-lightHover
           hover:shadow-dark hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
